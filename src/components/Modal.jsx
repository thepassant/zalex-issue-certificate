  ...
  const renderFooter = () => {
    ...
    return (
      <div className="modal-footer">
        {footerButtons && renderModalBtns(footerButtons)}
      </div>
    );
  };
      ...
      {show && (
        <Portal wrapperElement="span" wrapperElementId="modal">
          <div
            ...
            style={{
              cursor:
                closeHandler && !isCancelClickOnOverlay ? "pointer" : "initial",
              backgroundColor: isTransparentBackground ? "transparent" : "",
            }}
            onClick={(e) => {
              if (
                e.target === modalWrapperRef.current &&
          ...
          >
            <div
              ...
              style={{
                flexDirection:
                  wrapperHeader || wrapperFooter ? "column" : "row",
                justifyContent:
                  wrapperHeader || wrapperFooter ? "space-between" : "center",
              }}
              ref={modalWrapperRef}
            >
              {wrapperHeader}
